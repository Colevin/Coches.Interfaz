...
public class MapByRoadComponent extends JComponent implements TrafficSimObserver {
	...
	private void drawRoads(Graphics2D g) {
		...
		switch (C) {
		case 0:
			g.drawImage(cont0, x2+40, y , 32, 32, this);
			break;
			
		case 1:
			g.drawImage(cont1, x2+40, y , 32, 32, this);
			break;
		case 2:
			g.drawImage(cont2, x2+40, y , 32, 32, this);
			break;
		case 3:
			g.drawImage(cont3, x2+40, y , 32, 32, this);
			break;
		case 4:
			g.drawImage(cont4, x2+40, y , 32, 32, this);
			break;
		case 5:
			g.drawImage(cont5, x2+40, y , 32, 32, this);
			break;
			}
		i++;		
			}
